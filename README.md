...
1. Realizar un `commit` donde incluya los 5 (incluido el package-lock.json) archivos modificados con el mensaje **“setup mocha configuration”** y subir los cambios al repositorio
